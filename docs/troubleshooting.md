...
- **錯誤：`Failed to login. Message: Request contains an invalid argument`**
  ...
  - 或者，您也可以從 [Google AI Studio](http://aistudio.google.com/app/apikey) 取得 Gemini API 金鑰，該服務同樣提供獨立的免費層級。
...
- **錯誤："Operation not permitted"、"Permission denied" 或類似訊息。**
  ...
  - **解決方式：** 請參考 [Configuration: Sandboxing](./cli/configuration.md#sandboxing) 文件，了解更多資訊及如何自訂您的沙箱設定。
...
如果您遇到的問題未在本 _疑難排解指南_ 中涵蓋，請考慮在 Gemini CLI 的 [GitHub Issue 追蹤器](https://github.com/google-gemini/gemini-cli/issues) 搜尋。若找不到與您類似的問題，請考慮建立新的 GitHub Issue，並詳述您的情況。我們也歡迎 Pull Request！
